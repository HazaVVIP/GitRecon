...
print_r($arrIDOsAllNetwork);
print_r($arrIDOs);
print_r(array_count_values($arrIDOsAllNetwork));
echo "</pre>"; */
	...
	foreach($arrID as $id){
		...
		if($response_one['status']){
			...
			if(!empty($publish_date)){
				$allnetwork_id = strtotime($publish_date);
			} */
...
echo "Total Sync OS Article All Network : ".$totalSyncOs."<br>";
