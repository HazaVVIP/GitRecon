...
if($totalData > 0){
	...
	while($post = mysqli_fetch_assoc($result))
	{
		...
		$subtitle_alias = utf8($subtitle_alias, 'UTF-8');
		$introtext = utf8($introtext, 'UTF-8');
		$foto_caption = utf8($foto_caption, 'UTF-8');
		$foto_name = utf8($foto_name, 'UTF-8');
		...
		if(isset($arrInsert['title']) && !empty($arrInsert['title'])){
			...
			if($index_year_valid < 2025) array_push($arrDataInsert,$arrInsertAllNetwork);
