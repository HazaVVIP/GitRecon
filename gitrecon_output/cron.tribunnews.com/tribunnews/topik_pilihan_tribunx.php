	...
	foreach($arrTopikPilihan as $topil){
		...
		if($response1['status']){
			...
			if(count($arrArticleTopikPilihan)){
				...
				$response2 = $opensearchTBO->insert('tribunx-topikpilihan',$dataInsert);
