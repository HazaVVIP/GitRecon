...
$con = mysqli_connect("db-dev8.cuhyfpzt6xd5.ap-southeast-1.rds.amazonaws.com","dev-cms","buTlpr87RI0Tl-HuvuphubR5miPhls","tribunnews");
...
if(@count($videolist) > 0){
	...
	if(count($items) > 0){
		$sql_delete = "DELETE FROM frontpage_publish WHERE type = 'video-short'";
		//$del = mysqli_query($con, $sql_delete);
		...
		foreach($items as $i => $row){
			...
			if(!in_array($youtube_id, $arrYoutubeID) && $youtube_live_broadcast == "none"){
				...
				/* echo $youtube_id."<br>";
				echo $youtube_title." = ".$youtube_short_url."<br>";
				echo "<hr>"; */
				
				/* echo $youtube_title."<br>";
				echo $youtube_description."<br>";
				echo "<hr>"; */
