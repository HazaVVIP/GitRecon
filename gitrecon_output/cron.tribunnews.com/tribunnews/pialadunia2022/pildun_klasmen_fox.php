...
if($results != false){
	...
	$country = array('Ecuador','Poland','England', 'Netherlands', 'United States', 'France', 'Spain', 'Switzerland', 'Japan', 'Belgium', 'Germany', 'South Korea', 'Brazil','Morocco');
	$translate = array('Ekuador','Polandia','Inggris', 'Belanda', 'Amerika serikat', 'Prancis', 'Spanyol', 'Swiss', 'Jepang', 'Belgia', 'Jerman', 'Korea Selatan', 'Brasil','Maroko');
