		...
		foreach($arrID as $id){
			...
			if(!empty($id)){
				...
				$arrInsert['allnetwork_id'] = $allnetwork_id;
					...
					$arrInsertAllNetwork['domain_id'] = $arrInsertAllNetwork['id'];
					$arrInsertAllNetwork['domain'] = $site;
					$arrUpdateAllNetwork['lastupdate_date'] = date('Y-m-d H:i:s');
					$arrUpdateAllNetwork['content_status'] = 2;
