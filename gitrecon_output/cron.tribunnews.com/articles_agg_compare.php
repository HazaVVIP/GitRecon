...
$response_es = $elasticsearch->find('tribunnews-articles_agg',$condition,$fields,$sort,$start,$limit);
$totalEs = 0;
$arrIDEs = array();
...
$response_os = $opensearch->find('tribunnews-articles_agg',$condition,$fields,$sort,$start,$limit);
$totalOs = 0;
$arrIDOs = array();
