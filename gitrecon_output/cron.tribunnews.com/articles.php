...
$writelog->Log(PATH_ROOT."/logs/","tribunnews-articles");

$lastid = 0;
$total = 0;
$filename = PATH_ROOT . "/data/lastid_articles.txt";
...
if (empty($lastid)) {
	...
	$start = 0;
	$limit = 2250;
	$response = $elasticsearch->find('tribunnews-articles',$condition,$fields,$sort,$start,$limit);
	
	$response_total = $elasticsearch->count_total('tribunnews-articles',$condition);
} else {
