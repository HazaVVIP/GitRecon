...
For a pinned release or a manual checksum-verified download, use the assets listed on the [v3.2.7 release page](https://github.com/HazaVVIP/GitRecon/releases/tag/v3.2.7). The Linux archive is named `gitrecon-3.2.7-linux-x86_64.tar.gz`; verify it against the matching entry in `SHA256SUMS` before extraction.
